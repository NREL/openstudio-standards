...
class SpreadSheetMaterial
  ...
  def initialize(model_object)
    @model_object = nil
    if !model_object.to_StandardOpaqueMaterial.empty?
    ...
    elsif !model_object.to_MasslessOpaqueMaterial.empty?
    ...
    elsif !model_object.to_AirGap.empty?
    ...
    elsif !model_object.to_Gas.empty?
    ...
    elsif !model_object.to_SimpleGlazing .empty?
    ...
    elsif !model_object.to_StandardGlazing .empty?
...
class ConstructionNameParser
  ...
  def climate_zone_set
    ...
    if '1' == @climate_zone_set || 'alt-res 1' == @climate_zone_set
      result = 'ClimateZone 1'
    elsif '2' == @climate_zone_set || 'alt-res 2' == @climate_zone_set
      result = 'ClimateZone 2'
    elsif '2a' == @climate_zone_set
      result = 'ClimateZone 2a'
    elsif '2b' == @climate_zone_set || '2b 1' == @climate_zone_set
      result = 'ClimateZone 2b'
    elsif '3' == @climate_zone_set || 'alt-res 3' == @climate_zone_set
      ...
      result = 'ClimateZone 3b'    # Right?
    elsif '3c' == @climate_zone_set || 'alt-res 3c' == @climate_zone_set
      result = 'ClimateZone 3c'
    elsif '4' == @climate_zone_set || 'alt-res 4' == @climate_zone_set
    ...
    elsif '5' == @climate_zone_set || 'alt-res 5' == @climate_zone_set
      result = 'ClimateZone 5'
    elsif '5a' == @climate_zone_set
      result = 'ClimateZone 5a'
    elsif '5b' == @climate_zone_set || '5b 1' == @climate_zone_set
      result = 'ClimateZone 5b'
    elsif '6' == @climate_zone_set || 'alt-res 6' == @climate_zone_set
      result = 'ClimateZone 6'
    elsif '6a' == @climate_zone_set
      result = 'ClimateZone 6a'
    elsif '6b' == @climate_zone_set
      result = 'ClimateZone 6b'
    elsif '7' == @climate_zone_set || 'alt-res 7' == @climate_zone_set || '7 1' == @climate_zone_set
      result = 'ClimateZone 7'
    elsif '8' == @climate_zone_set || 'alt-res 8' == @climate_zone_set
      result = 'ClimateZone 8'
    elsif '1-2' == @climate_zone_set || 'alt-res 1-2' == @climate_zone_set
    ...
    elsif '1-8' == @climate_zone_set || 'alt-lrgoff hosp 1-8' == @climate_zone_set || 'alt-ware 1-8' == @climate_zone_set
      result = 'ClimateZone 1-8'
    elsif '2-3' == @climate_zone_set
      result = 'ClimateZone 2-3'
    elsif '2-5' == @climate_zone_set
      result = 'ClimateZone 2-5'
    elsif '3a-3b' == @climate_zone_set || 'alt-resH 3a-3b' == @climate_zone_set || 'alt-resA 3a-3b' == @climate_zone_set
      result = 'ClimateZone 3a-3b'
    elsif '3-4' == @climate_zone_set
      result = 'ClimateZone 3-4'
    elsif '4-5' == @climate_zone_set || 'alt-res 4-5' == @climate_zone_set
      result = 'ClimateZone 4-5'
    elsif '4-6' == @climate_zone_set || 'alt-res 4-6' == @climate_zone_set
    ...
    elsif '5-6' == @climate_zone_set || '5-6 1' == @climate_zone_set || 'alt-res 5-6' == @climate_zone_set
...
class SpreadSheetConstructionSet
  ...
  def initialize(model_object)
    ...
    unless defaultExteriorSurfaceConstructions.empty?
    ...
    unless defaultInteriorSurfaceConstructions.empty?
    ...
    unless defaultGroundContactSurfaceConstructions.empty?
    ...
    unless defaultExteriorSubSurfaceConstructions.empty?
    ...
    unless defaultInteriorSubSurfaceConstructions.empty?
