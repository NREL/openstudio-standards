...
level_3_lighting_defintion_id: id from level_3_lighting_definition index
"""
...
level_3_lighting_defintion_id INTEGER NOT NULL,
...
INSERT_LIGHT_SUBSPACE = f"""
    ...
    (lighting_space_type_name, level_3_lighting_definition_table, level_3_lighting_defintion_id)
    VALUES (?, ?, ?);
"""
...
class LightSubspaceTable(DBOperation):
    ...
    def _preprocess_record(self, record):
        ...
        record_list = (
            ...
            getattr_either("level_3_lighting_defintion_id", record),
        )
