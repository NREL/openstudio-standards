...
level_3_ventilation_defintion_id: id from level_3_ventilation_definition index
"""
...
level_3_ventilation_defintion_id INTEGER NOT NULL,
...
INSERT_VENT_SUBSPACE = f"""
    ...
    (ventilation_space_type_name, level_3_ventilation_definition_table, level_3_ventilation_defintion_id)
    VALUES (?, ?, ?);
"""
...
class VentSubspaceTable(DBOperation):
    ...
    def _preprocess_record(self, record):
        ...
        record_list = (
            ...
            getattr_either("level_3_ventilation_defintion_id", record),
        )
