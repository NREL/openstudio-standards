class OSSTDDataException(Exception):
    def __init__(self, message):
        super().__init__(message)


class OSSTDFormDataException(OSSTDDataException):
    def __init__(self, message):
        super().__init__(message)
...
def assert_(b: bool, err_msg: str):
    if not b:
        raise OSSTDFormDataException(err_msg)


class MissingKeyException(OSSTDDataException):
