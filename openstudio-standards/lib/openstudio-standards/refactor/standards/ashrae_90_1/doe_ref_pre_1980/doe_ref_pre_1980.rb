  ...
  def create_prototype_model( building_type, climate_zone, epw_file, sizing_run_dir = Dir.pwd, debug = false)
    ...
    case @@template
      when 'NECB 2011'
        ...
        add_hvac(building_type, climate_zone, prototype_input, epw_file)
        osm_file_increment += 1
        ...
        model_create_thermal_zones(model, building_type, climate_zone)
        add_hvac(building_type, climate_zone, prototype_input, epw_file)
        custom_hvac_tweaks(building_type, climate_zone, prototype_input, self)
        add_swh(building_type, climate_zone, prototype_input, epw_file)
        custom_swh_tweaks(building_type, climate_zone, prototype_input, self)
