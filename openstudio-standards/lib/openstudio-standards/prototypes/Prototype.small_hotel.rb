...
class OpenStudio::Model::Model
  def define_space_type_map(building_type, building_vintage, climate_zone)
    ...
    when 'DOE Ref Pre-1980'
      space_type_map = {
        'Corridor' => %w(CorridorFlr1 CorridorFlr2 CorridorFlr3 CorridorFlr4),
        'Elec/MechRoom' => ['ElevatorCoreFlr1'],
        'ElevatorCore' => %w(ElevatorCoreFlr2 ElevatorCoreFlr3 ElevatorCoreFlr4),
        'StaffLounge' => ['EmployeeLoungeFlr1'],
        'Exercise' => ['ExerciseCenterFlr1'],
        'GuestLounge' => ['FrontLoungeFlr1'],
        'Office' => ['FrontOfficeFlr1'],
        'Stair' => %w(FrontStairsFlr1 FrontStairsFlr2 FrontStairsFlr3 FrontStairsFlr4
                      RearStairsFlr1 RearStairsFlr2 RearStairsFlr3 RearStairsFlr4),
        'Storage' => %w(FrontStorageFlr1 FrontStorageFlr2 FrontStorageFlr3 FrontStorageFlr4
                        RearStorageFlr1 RearStorageFlr2 RearStorageFlr3 RearStorageFlr4),
        'GuestRoom' => %w(GuestRoom101 GuestRoom102 GuestRoom103 GuestRoom104 GuestRoom105
    ...
    when '90.1-2010', '90.1-2007', '90.1-2004', '90.1-2013'
      space_type_map = {
        'Corridor' => %w(CorridorFlr1 CorridorFlr2 CorridorFlr3),
        'Corridor4' => ['CorridorFlr4'],
        'Elec/MechRoom' => ['ElevatorCoreFlr1'],
        'ElevatorCore' => %w(ElevatorCoreFlr2 ElevatorCoreFlr3),
        'ElevatorCore4' => ['ElevatorCoreFlr4'],
        'StaffLounge' => ['EmployeeLoungeFlr1'],
        'Exercise' => ['ExerciseCenterFlr1'],
        'GuestLounge' => ['FrontLoungeFlr1'],
        'Office' => ['FrontOfficeFlr1'],
        'Stair' => %w(FrontStairsFlr1 FrontStairsFlr2 FrontStairsFlr3
                      RearStairsFlr1 RearStairsFlr2 RearStairsFlr3),
        'Stair4' => %w(FrontStairsFlr4 RearStairsFlr4),
        'Storage' => %w(FrontStorageFlr1 FrontStorageFlr2 FrontStorageFlr3
                        RearStorageFlr1 RearStorageFlr2 RearStorageFlr3),
        'Storage4Front' => ['FrontStorageFlr4'],
        'Storage4Rear' => ['RearStorageFlr4'],
        'GuestRoom123Occ' => %w(GuestRoom103 GuestRoom104 GuestRoom105 GuestRoom202_205 GuestRoom206_208
        ...
        'GuestRoom123Vac' => %w(GuestRoom101 GuestRoom102 GuestRoom201 GuestRoom215_218 GuestRoom301
                                GuestRoom302_305 GuestRoom306_308 GuestRoom313 GuestRoom319 GuestRoom324),
        'GuestRoom4Occ' => %w(GuestRoom401 GuestRoom409_412 GuestRoom415_418 GuestRoom419 GuestRoom420_423 GuestRoom424),
        'GuestRoom4Vac' => %w(GuestRoom402_405 GuestRoom406_408 GuestRoom413 GuestRoom414),
        'Laundry' => ['LaundryRoomFlr1'],
        'Mechanical' => ['MechanicalRoomFlr1'],
        'Meeting' => ['MeetingRoomFlr1'],
        'PublicRestroom' => ['RestroomFlr1'],
    ...
    when 'NECB 2011'
      sch = 'F'
      space_type_map = {
        "Corr. >= 2.4m wide-sch-#{sch}" => %w(CorridorFlr1 CorridorFlr2 CorridorFlr3 CorridorFlr4),
        'Lobby - elevator' => %w(ElevatorCoreFlr1 ElevatorCoreFlr2 ElevatorCoreFlr3 ElevatorCoreFlr4),
        ...
        "Stairway-sch-#{sch}" => %w(FrontStairsFlr1 FrontStairsFlr2 FrontStairsFlr3 FrontStairsFlr4 RearStairsFlr1 RearStairsFlr2 RearStairsFlr3 RearStairsFlr4),
        'Storage area' => %w(FrontStorageFlr1 FrontStorageFlr2 FrontStorageFlr3 FrontStorageFlr4 LaundryRoomFlr1 RearStorageFlr1 RearStorageFlr2 RearStorageFlr3 RearStorageFlr4),
        'Hway lodging - rooms' => %w(GuestRoom101 GuestRoom102 GuestRoom103 GuestRoom104 GuestRoom105 GuestRoom201 GuestRoom202_205 GuestRoom206_208 GuestRoom209_212 GuestRoom213 GuestRoom214 GuestRoom215_218 GuestRoom219 GuestRoom220_223 GuestRoom224 GuestRoom301 GuestRoom302_305 GuestRoom306_308 GuestRoom309_312 GuestRoom313 GuestRoom314 GuestRoom315_318 GuestRoom319 GuestRoom320_323 GuestRoom324 GuestRoom401 GuestRoom402_405 GuestRoom406_408 GuestRoom409_412 GuestRoom413 GuestRoom414 GuestRoom415_418 GuestRoom419 GuestRoom420_423 GuestRoom424),
        "Electrical/Mechanical-sch-#{sch}" => %w(MechanicalRoomFlr1 MeetingRoomFlr1),
  ...
  def define_hvac_system_map(building_type, building_vintage, climate_zone)
    ...
    when '90.1-2010', '90.1-2007', '90.1-2004', '90.1-2013'
      system_to_space_map = [
        ...
        { 'type' => 'SAC',
          'space_names' => %w(ExerciseCenterFlr1 EmployeeLoungeFlr1 RestroomFlr1) },
        { 'type' => 'SAC',
          'space_names' => ['FrontLoungeFlr1'] },
        { 'type' => 'SAC',
          'space_names' => ['FrontOfficeFlr1'] },
