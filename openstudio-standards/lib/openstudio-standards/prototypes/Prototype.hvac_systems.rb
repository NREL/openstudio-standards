...
class OpenStudio::Model::Model
  ...
  def add_vav(prototype_input, standards, sys_name, hot_water_loop, chilled_water_loop, thermal_zones, building_type=nil, return_plenum = nil)
    ...
    thermal_zones.each do |zone|
      ...
      terminal.set_initial_prototype_damper_position(prototype_input['building_type'], prototype_input['building_type'], prototype_input['template'], zone.outdoor_airflow_rate_per_area)
