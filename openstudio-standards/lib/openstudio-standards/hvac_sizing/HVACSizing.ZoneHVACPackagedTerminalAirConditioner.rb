...
class OpenStudio::Model::ZoneHVACPackagedTerminalAirConditioner
  ...
  def applySizingValues
    ...
    OpenStudio::logFree(OpenStudio::Warn, "openstudio.sizing.ZoneHVACPackagedTerminalAirConditioner", ".applySizingValues not yet implemented for #{self.iddObject.type.valueDescription}.")
