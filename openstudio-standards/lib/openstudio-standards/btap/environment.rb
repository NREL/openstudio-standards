...
module BTAP
  module Environment
    ...
    WeatherData1 = [   
      ...
      {:file=>"CAN_MB_Brandon.711400_CWEC.epw", :location_name=>" CAN-MB-Brandon", :energy_plus_location_name=>"Brandon_MB_CAN", :country=>"CAN", :state_province_region=>"MB", :city=>" Brandon", :hdd18=>5912, :cdd18=>95, :latitude=>49.92, :longitude=>-99.95, :elevation=>409, :deltadb=>36.7, :a90_1_2004_climate_zone=>7, :boiler_fueltype=>"Electricity", :baseboard_type=>"Electricity", :mau_type=>true, :mau_heating_coil_type=>"Electric", :mau_cooling_type=>"DX", :chiller_type=>"Scroll", :heating_coil_type_sys_3=>"Electric", :heating_coil_type_sys4and6=>"Electric", :fan_type=>"var_speed_drive"},
      {:file=>"CAN_MB_Churchill.719130_CWEC.epw", :location_name=>" CAN-MB-Churchill", :energy_plus_location_name=>"Churchill_MB_CAN", :country=>"CAN", :state_province_region=>"MB", :city=>" Churchill", :hdd18=>9114, :cdd18=>3, :latitude=>58.75, :longitude=>-94.07, :elevation=>29, :deltadb=>37.7, :a90_1_2004_climate_zone=>8, :boiler_fueltype=>"Electricity", :baseboard_type=>"Electricity", :mau_type=>true, :mau_heating_coil_type=>"Electric", :mau_cooling_type=>"DX", :chiller_type=>"Scroll", :heating_coil_type_sys_3=>"Electric", :heating_coil_type_sys4and6=>"Electric", :fan_type=>"var_speed_drive"},
      ...
      {:file=>"CAN_NF_St.Johns.718010_CWEC.epw", :location_name=>" CAN-NF-St John's", :energy_plus_location_name=>"St John's_NF_CAN", :country=>"CAN", :state_province_region=>"NF", :city=>" St John's", :hdd18=>4886, :cdd18=>24, :latitude=>47.62, :longitude=>-52.73, :elevation=>140, :deltadb=>20.5, :a90_1_2004_climate_zone=>"6A", :boiler_fueltype=>"Electricity", :baseboard_type=>"Electricity", :mau_type=>true, :mau_heating_coil_type=>"Electric", :mau_cooling_type=>"DX", :chiller_type=>"Scroll", :heating_coil_type_sys_3=>"Electric", :heating_coil_type_sys4and6=>"Electric", :fan_type=>"var_speed_drive"},
      {:file=>"CAN_NF_Stephenville.718150_CWEC.epw", :location_name=>" CAN-NF-Stephenville", :energy_plus_location_name=>"Stephenville_NF_CAN", :country=>"CAN", :state_province_region=>"NF", :city=>" Stephenville", :hdd18=>4724, :cdd18=>10, :latitude=>48.53, :longitude=>-58.55, :elevation=>26, :deltadb=>23.1, :a90_1_2004_climate_zone=>"6A", :boiler_fueltype=>"Electricity", :baseboard_type=>"Electricity", :mau_type=>true, :mau_heating_coil_type=>"Electric", :mau_cooling_type=>"DX", :chiller_type=>"Scroll", :heating_coil_type_sys_3=>"Electric", :heating_coil_type_sys4and6=>"Electric", :fan_type=>"var_speed_drive"},
      ...
      {:file=>"CAN_PE_Charlottetown.717060_CWEC.epw", :location_name=>" CAN-PE-Charlottetown CDA", :energy_plus_location_name=>"Charlottetown CDA_PE_CAN", :country=>"CAN", :state_province_region=>"PE", :city=>" Charlottetown CDA", :hdd18=>4647, :cdd18=>72, :latitude=>46.28, :longitude=>-63.13, :elevation=>54, :deltadb=>25.6, :a90_1_2004_climate_zone=>"6A", :boiler_fueltype=>"Electricity", :baseboard_type=>"Electricity", :mau_type=>true, :mau_heating_coil_type=>"Electric", :mau_cooling_type=>"DX", :chiller_type=>"Scroll", :heating_coil_type_sys_3=>"Electric", :heating_coil_type_sys4and6=>"Electric", :fan_type=>"var_speed_drive"},
      ...
      {:file=>"CAN_PQ_Montreal.Intl.AP.716270_CWEC.epw", :location_name=>" CAN-PQ-Montreal Int'l", :energy_plus_location_name=>"Montreal Int'l_PQ_CAN", :country=>"CAN", :state_province_region=>"PQ", :city=>" Montreal Int'l", :hdd18=>4493, :cdd18=>234, :latitude=>45.47, :longitude=>-73.75, :elevation=>36, :deltadb=>30.2, :a90_1_2004_climate_zone=>"6A", :boiler_fueltype=>"Electricity", :baseboard_type=>"Electricity", :mau_type=>true, :mau_heating_coil_type=>"Electric", :mau_cooling_type=>"DX", :chiller_type=>"Scroll", :heating_coil_type_sys_3=>"Electric", :heating_coil_type_sys4and6=>"Electric", :fan_type=>"var_speed_drive"},
      {:file=>"CAN_PQ_Montreal.Jean.Brebeuf.716278_CWEC.epw", :location_name=>" CAN-PQ-Montreal Jean Brebeuf", :energy_plus_location_name=>"Montreal Jean Brebeuf_PQ_CAN", :country=>"CAN", :state_province_region=>"PQ", :city=>" Montreal Jean Brebeuf", :hdd18=>4616, :cdd18=>209, :latitude=>45.5, :longitude=>-73.62, :elevation=>133, :deltadb=>31.2, :a90_1_2004_climate_zone=>"6A", :boiler_fueltype=>"Electricity", :baseboard_type=>"Electricity", :mau_type=>true, :mau_heating_coil_type=>"Electric", :mau_cooling_type=>"DX", :chiller_type=>"Scroll", :heating_coil_type_sys_3=>"Electric", :heating_coil_type_sys4and6=>"Electric", :fan_type=>"var_speed_drive"},
      {:file=>"CAN_PQ_Montreal.Mirabel.716278_CWEC.epw", :location_name=>" CAN-PQ-Montreal Mirabel", :energy_plus_location_name=>"Montreal Mirabel_PQ_CAN", :country=>"CAN", :state_province_region=>"PQ", :city=>" Montreal Mirabel", :hdd18=>4861, :cdd18=>102, :latitude=>45.68, :longitude=>-74.03, :elevation=>82, :deltadb=>33.4, :a90_1_2004_climate_zone=>"6A", :boiler_fueltype=>"Electricity", :baseboard_type=>"Electricity", :mau_type=>true, :mau_heating_coil_type=>"Electric", :mau_cooling_type=>"DX", :chiller_type=>"Scroll", :heating_coil_type_sys_3=>"Electric", :heating_coil_type_sys4and6=>"Electric", :fan_type=>"var_speed_drive"},
      {:file=>"CAN_PQ_Nitchequon.CAN270_CWEC.epw", :location_name=>" CAN-PQ-Nitchequon", :energy_plus_location_name=>"Nitchequon_PQ_CAN", :country=>"CAN", :state_province_region=>"PQ", :city=>" Nitchequon", :hdd18=>7922, :cdd18=>6, :latitude=>53.2, :longitude=>-70.9, :elevation=>536, :deltadb=>35.8, :a90_1_2004_climate_zone=>8, :boiler_fueltype=>"Electricity", :baseboard_type=>"Electricity", :mau_type=>true, :mau_heating_coil_type=>"Electric", :mau_cooling_type=>"DX", :chiller_type=>"Scroll", :heating_coil_type_sys_3=>"Electric", :heating_coil_type_sys4and6=>"Electric", :fan_type=>"var_speed_drive"},
      {:file=>"CAN_PQ_Quebec.717140_CWEC.epw", :location_name=>" CAN-PQ-Quebec City", :energy_plus_location_name=>"Quebec City_PQ_CAN", :country=>"CAN", :state_province_region=>"PQ", :city=>" Quebec City", :hdd18=>4964, :cdd18=>111, :latitude=>46.8, :longitude=>-71.38, :elevation=>73, :deltadb=>31, :a90_1_2004_climate_zone=>"6A", :boiler_fueltype=>"Electricity", :baseboard_type=>"Electricity", :mau_type=>true, :mau_heating_coil_type=>"Electric", :mau_cooling_type=>"DX", :chiller_type=>"Scroll", :heating_coil_type_sys_3=>"Electric", :heating_coil_type_sys4and6=>"Electric", :fan_type=>"var_speed_drive"},
    ...
    #Location,Province,boiler_fueltype,baseboard_type,mau_type,mau_heating_coil_type,mau_cooling_type,chiller_type,heating_coil_type_sys_3,heating_coil_type_sys4and6,fan_type
    #Montreal Int'l_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #St Hubert_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Roberval_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Sherbrooke_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Lake Eon_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Schefferville_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Kuujjuarapik_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Mont Joli_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Quebec City_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Riviere Du Loup_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Baie Comeau_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Bagotville_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Sept-Iles_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Nitchequon_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Grindstone Island_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #La Grande Riviere_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Montreal Jean Brebeuf_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Ste Agathe Des Monts_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Montreal Mirabel_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Val d'Or_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Kuujuaq_PQ_CAN,Quebec,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #St John's_NF_CAN,Newfoundland,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Gander Int'l_NF_CAN,Newfoundland,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Goose_NF_CAN,Newfoundland,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Stephenville_NF_CAN,Newfoundland,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Battle Harbour_NF_CAN,Newfoundland,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Saint John_NB_CAN,New Brunswick,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Fredericton_NB_CAN,New Brunswick,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Miramichi_NB_CAN,New Brunswick,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Greenwood_NS_CAN,Nova Scotia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Truro_NS_CAN,Nova Scotia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Sable Island_NS_CAN,Nova Scotia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Sydney_NS_CAN,Nova Scotia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Shearwater_NS_CAN,Nova Scotia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Charlottetown CDA_PE_CAN,Prince Edward Island,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Ottawa Int'l_ON_CAN,Ontario,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Trenton_ON_CAN,Ontario,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #North Bay_ON_CAN,Ontario,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Kingston_ON_CAN,Ontario,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Toronto Int'l_ON_CAN,Ontario,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Timmins_ON_CAN,Ontario,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Mount Forest_ON_CAN,Ontario,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Muskoka_ON_CAN,Ontario,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Windsor_ON_CAN,Ontario,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #London_ON_CAN,Ontario,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Simcoe_ON_CAN,Ontario,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Thunder Bay_ON_CAN,Ontario,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Sault Ste Marie_ON_CAN,Ontario,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #The Pas_MB_CAN,Manitoba,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #The Pas_MB_CAN,Manitoba,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Winnipeg Int'l_MB_CAN,Manitoba,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Churchill_MB_CAN,Manitoba,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Brandon_MB_CAN,Manitoba,Electricity,Electricity,TRUE,Electric,DX,Scroll,Electric,Electric,var_speed_drive
    #Regina_SK_CAN,Saskatchewan,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #North Battleford_SK_CAN,Saskatchewan,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Estevan_SK_CAN,Saskatchewan,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Saskatoon_SK_CAN,Saskatchewan,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Swift Current_SK_CAN,Saskatchewan,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Calgary Int'l_AB_CAN,Alberta,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Medicine Hat_AB_CAN,Alberta,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Lethbridge_AB_CAN,Alberta,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Grand Prairie_AB_CAN,Alberta,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Fort McMurray_AB_CAN,Alberta,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Edmonton Stony Plain_AB_CAN,Alberta,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Abbotsford_BC_CAN,British Columbia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Kamloops_BC_CAN,British Columbia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Vancouver Int'l_BC_CAN,British Columbia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Cranbrook_BC_CAN,British Columbia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Summerland_BC_CAN,British Columbia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Victoria Int'l_BC_CAN,British Columbia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Sandspit_BC_CAN,British Columbia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Port Hardy_BC_CAN,British Columbia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Comox_BC_CAN,British Columbia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Prince Rupert_BC_CAN,British Columbia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Fort St John_BC_CAN,British Columbia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Prince George_BC_CAN,British Columbia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Smithers_BC_CAN,British Columbia,NaturalGas,Hot Water,TRUE,Hot Water,DX,Scroll,Gas,Gas,var_speed_drive
    #Whitehorse_YT_CAN,Yukon,FuelOil#1,Hot Water,TRUE,Hot Water,DX,Scroll,Electric,Electric,var_speed_drive
    #Inuvik Ua_NT_CAN,Northwest Territories,FuelOil#1,Hot Water,TRUE,Hot Water,DX,Scroll,Electric,Electric,var_speed_drive
    #Resolute_NU_CAN,Nunavut,FuelOil#2,Hot Water,TRUE,Hot Water,DX,Scroll,Electric,Electric,var_speed_drive
    ...
    def self.get_canadian_system_defaults_by_weatherfile_name(epw_file)
      if data = BTAP::Environment::WeatherData1.find { |data| data[:file] == epw_file.strip }
        return  data[:boiler_fueltype], data[:baseboard_type], data[:mau_type], data[:mau_heating_coil_type],  data[:mau_cooling_type], data[:chiller_type], data[:heating_coil_type_sys_3], data[:heating_coil_type_sys4and6], data[:fan_type]
      else
        puts 'Not found!'
      end
