...
class TestMediumOffice < CreateDOEPrototypeBuildingTest
  ...
  templates = ['90.1-2013']
  climate_zones = ['ASHRAE 169-2006-1A', 'ASHRAE 169-2006-1B', 
                   ...
                   'ASHRAE 169-2006-5A', 'ASHRAE 169-2006-5B', 'ASHRAE 169-2006-5C',
                   'ASHRAE 169-2006-6A', 'ASHRAE 169-2006-6B', 
                   'ASHRAE 169-2006-7A', 
                   'ASHRAE 169-2006-8A']

  # not used for ASHRAE/DOE archetypes, but required for call
  epw_files = ['USA_FL_Miami.Intl.AP.722020_TMY3.epw',                   'SAU_Riyadh.404380_IWEC.epw',
               ...
               'USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.epw',           'USA_ID_Boise.Air.Terminal.726810_TMY3.epw',  	     'CAN_BC_Vancouver.718920_CWEC.epw',
