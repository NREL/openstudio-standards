...
class TestSmallDataCenter < CreateDOEPrototypeBuildingTest

  building_types = ['SmallDataCenter']

  # templates = ['HighITE']  
  templates = ['LowITE', 'HighITE']
  climate_zones = ['ASHRAE 169-2006-1A']#,'ASHRAE 169-2006-3B','ASHRAE 169-2006-4A','ASHRAE 169-2006-5A']
  ...
  TestSmallDataCenter.create_run_model_tests(building_types, templates, climate_zones, epw_files, create_models, run_models, compare_results, debug)
