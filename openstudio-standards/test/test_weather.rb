...
class NECBHDDTests < Minitest::Test
  ...
  def setup()
    ...
    length = 100.0; width = 100.0 ; num_above_ground_floors = 3; num_under_ground_floors = 1; floor_to_floor_height = 3.8 ; plenum_height = 1; perimeter_zone_depth = 4.57
    ...
    subsurfaces.each do |subsurface|
      ...
      skylights = OpenStudio::Model::applySkylightPattern(pattern, @model.getSpaces, OpenStudio::Model::OptionalConstructionBase.new)
      #To do Set every second skylight to an overhead door, and daylight diffusers. 
