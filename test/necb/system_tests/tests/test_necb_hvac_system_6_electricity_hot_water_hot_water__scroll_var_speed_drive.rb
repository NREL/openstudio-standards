...
class NECB_HVAC_System_6_Test_E_HW_HW_S_VSD < MiniTest::Test

  def test_necb_hvac_system_6_electricity_hot_water_hot_water__scroll_var_speed_drive()
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_6_electricity_hot_water_hot_water__scroll_var_speed_drive"
    name = 'test_necb_hvac_system_6_electricity_hot_water_hot_water__scroll_var_speed_drive""'
