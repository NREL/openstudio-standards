...
class NECB_HVAC_System_3_Test_E_DX_HW < MiniTest::Test

  def test_necb_hvac_system_3_electricity_dx_hot_water()
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_3_electricity_dx_hot_water"
