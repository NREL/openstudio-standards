...
class NECB_HVAC_System_2_Test_FO2_R_H_FPFC < MiniTest::Test
  ...
  def test_necb_hvac_system_2_fuel_oil2_reciprocating_hydronic_fpfc()
    ...
    fan_coil_type = 'FPFC'
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_2_fuel_oil2_reciprocating_hydronic_fpfc"
