...
class NECB_HVAC_System_4_Test_E_E_HW < MiniTest::Test

  def test_necb_hvac_system_4_electricity_electric_hot_water()
    vintage = ['NECB2011']
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_4_electricity_electric_hot_water"
