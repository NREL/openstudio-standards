...
class NECB_HVAC_System_1_Test_E_F_HW_HW < MiniTest::Test
  ...
  def test_necb_hvac_system_1_electricity_false_hot_water_hot_water()
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_1_electricity_false_hot_water_hot_water"
