...
class NECB_HVAC_System_6_Test_NG_HW_E_S_FC_IV < MiniTest::Test
  ...
  def test_necb_hvac_system_6_natural_gas_hot_water_electric__scroll_fc_inletvanes()
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_6_natural_gas_hot_water_electric__scroll_fc_inletvanes"
    name = 'test_necb_hvac_system_6_natural_gas_hot_water_electric__scroll_fc_inletvanes""'
