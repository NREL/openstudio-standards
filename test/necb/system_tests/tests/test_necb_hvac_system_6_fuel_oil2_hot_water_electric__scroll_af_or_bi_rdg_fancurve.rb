...
class NECB_HVAC_System_6_Test_FO2_HW_E_S_AFORBI_RDG_FC < MiniTest::Test

  def test_necb_hvac_system_6_fuel_oil2_hot_water_electric__scroll_af_or_bi_rdg_fancurve()
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_6_fuel_oil2_hot_water_electric__scroll_af_or_bi_rdg_fancurve"
    name = 'test_necb_hvac_system_6_fuel_oil2_hot_water_electric__scroll_af_or_bi_rdg_fancurve""'
