...
class NECB_HVAC_System_6_Test_E_HW_HW_S_AFORBI_IV < MiniTest::Test

  def test_necb_hvac_system_6_electricity_hot_water_hot_water__scroll_af_or_bi_inletvanes()
    ...
    chiller_type = 'Scroll'
    fan_type = 'AF_or_BI_inletvanes'
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_6_electricity_hot_water_hot_water__scroll_af_or_bi_inletvanes"
    name = 'test_necb_hvac_system_6_electricity_hot_water_hot_water__scroll_af_or_bi_inletvanes""'
