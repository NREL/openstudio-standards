...
class NECB_HVAC_System_6_Test_E_E_E_S_AFORBI_IV < MiniTest::Test

  def test_necb_hvac_system_6_electricity_electric_electric__scroll_af_or_bi_inletvanes()
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_6_electricity_electric_electric__scroll_af_or_bi_inletvanes"
    name = 'test_necb_hvac_system_6_electricity_electric_electric__scroll_af_or_bi_inletvanes""'
