...
class NECB_HVAC_System_2_Test_NG_RS_H_FPFC < MiniTest::Test
  ...
  def test_necb_hvac_system_2_natural_gas_rotary_screw_hydronic_fpfc()
    ...
    fan_coil_type = 'FPFC'
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_2_natural_gas_rotary_screw_hydronic_fpfc"
