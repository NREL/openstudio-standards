...
class NECB_HVAC_System_1_TestE_F_E_HW < MiniTest::Test
  ...
  def test_necb_hvac_system_1_electricity_false_electric_hot_water()
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_1_electricity_false_electric_hot_water"
