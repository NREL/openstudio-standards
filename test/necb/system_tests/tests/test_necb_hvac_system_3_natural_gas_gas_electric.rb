...
class NECB_HVAC_System_3_Test_NG_G_E < MiniTest::Test

  def test_necb_hvac_system_3_natural_gas_gas_electric()
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_3_natural_gas_gas_electric"
