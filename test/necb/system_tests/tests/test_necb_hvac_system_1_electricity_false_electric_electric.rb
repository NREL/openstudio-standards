...
class NECB_HVAC_System_1_Test_E_F_E_E < MiniTest::Test
  ...
  def test_necb_hvac_system_1_electricity_false_electric_electric()
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_1_electricity_false_electric_electric"
