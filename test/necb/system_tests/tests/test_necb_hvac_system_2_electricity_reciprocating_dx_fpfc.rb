...
class NECB_HVAC_System_2_Test_E_R_DX_FPFC < MiniTest::Test
  ...
  def test_necb_hvac_system_2_electricity_reciprocating_dx_fpfc()
    ...
    mua_cooling_type = 'DX'
    fan_coil_type = 'FPFC'
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_2_electricity_reciprocating_dx_fpfc"
