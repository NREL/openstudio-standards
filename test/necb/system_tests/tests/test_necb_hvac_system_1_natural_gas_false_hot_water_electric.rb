...
class NECB_HVAC_System_1_Test_NG_F_HW_E < MiniTest::Test
  ...
  def test_necb_hvac_system_1_natural_gas_false_hot_water_electric()
    ...
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_1_natural_gas_false_hot_water_electric"
