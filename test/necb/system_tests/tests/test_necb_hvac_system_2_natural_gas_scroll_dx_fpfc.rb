...
class NECB_HVAC_System_2_Test_NG_S_DX_FPFC < MiniTest::Test


  #System #2
  #Sizing Convergence Errors when mua_cooling_types = DX
  def test_necb_hvac_system_2_natural_gas_scroll_dx_fpfc()
    ...
    mua_cooling_type = 'DX'
    fan_coil_type = 'FPFC'
    output_folder = "#{File.dirname(__FILE__)}/output/test_necb_hvac_system_2_natural_gas_scroll_dx_fpfc"
