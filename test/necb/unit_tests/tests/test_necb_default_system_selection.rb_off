...
class DefaultSystemSelectionTests < Minitest::Test
  ...
  def test_system_selection()
    ...
    test_result_file = File.join(@test_results_folder, 'space_type_system_selection_test_results.json')
    ...
    expected_result_file = File.join(@expected_results_folder, 'space_type_system_selection_expected_results.json')
