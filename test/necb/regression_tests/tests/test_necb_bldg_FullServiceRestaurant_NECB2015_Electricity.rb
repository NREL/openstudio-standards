...
class Test_FullServiceRestaurant_NECB2015_Electricity < NECBRegressionHelper
  ...
  def test_NECB2015_FullServiceRestaurant_regression_Electricity()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/FullServiceRestaurant-NECB2015-Electricity_CAN_AB_Calgary_diffs.json"
