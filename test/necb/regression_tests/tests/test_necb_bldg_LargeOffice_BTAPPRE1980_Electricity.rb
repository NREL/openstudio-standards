...
class Test_LargeOffice_BTAPPRE1980_Electricity < NECBRegressionHelper
  ...
  def test_BTAPPRE1980_LargeOffice_regression_Electricity()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/LargeOffice-BTAPPRE1980-Electricity_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
