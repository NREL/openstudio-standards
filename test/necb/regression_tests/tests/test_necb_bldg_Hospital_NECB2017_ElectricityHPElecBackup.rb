...
class Test_Hospital_NECB2017_ElectricityHPElecBackup < NECBRegressionHelper
  ...
  def test_NECB2017_Hospital_regression_ElectricityHPElecBackup()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/Hospital-NECB2017-ElectricityHPElecBackup_CAN_AB_Calgary_diffs.json"
