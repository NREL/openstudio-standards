...
class Test_MidriseApartment_BTAP1980TO2010_ElectricityHPGasBackupMixed < NECBRegressionHelper
  ...
  def test_BTAP1980TO2010_MidriseApartment_regression_ElectricityHPGasBackupMixed()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/MidriseApartment-BTAP1980TO2010-ElectricityHPGasBackupMixed_CAN_AB_Calgary_diffs.json"
