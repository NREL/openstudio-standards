...
class Test_FullServiceRestaurant_BTAPPRE1980_Electricity < NECBRegressionHelper
  ...
  def test_BTAPPRE1980_FullServiceRestaurant_regression_Electricity()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/FullServiceRestaurant-BTAPPRE1980-Electricity_CAN_AB_Calgary_diffs.json"
