...
class Test_QuickServiceRestaurant_BTAPPRE1980_NaturalGasHPElecBackupMixed < NECBRegressionHelper
  ...
  def test_BTAPPRE1980_QuickServiceRestaurant_regression_NaturalGasHPElecBackupMixed()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/QuickServiceRestaurant-BTAPPRE1980-NaturalGasHPElecBackupMixed_CAN_AB_Calgary_diffs.json"
