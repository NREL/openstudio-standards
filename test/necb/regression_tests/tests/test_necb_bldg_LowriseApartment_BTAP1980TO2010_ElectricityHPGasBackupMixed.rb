...
class Test_LowriseApartment_BTAP1980TO2010_ElectricityHPGasBackupMixed < NECBRegressionHelper
  def setup()
    super()
  end
  ...
  def test_BTAP1980TO2010_LowriseApartment_regression_ElectricityHPGasBackupMixed()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/LowriseApartment-BTAP1980TO2010-ElectricityHPGasBackupMixed_CAN_AB_Calgary_diffs.json"
