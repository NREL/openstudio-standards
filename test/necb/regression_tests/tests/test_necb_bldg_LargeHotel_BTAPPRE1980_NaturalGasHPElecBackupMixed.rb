...
class Test_LargeHotel_BTAPPRE1980_NaturalGasHPElecBackupMixed < NECBRegressionHelper
  ...
  def test_BTAPPRE1980_LargeHotel_regression_NaturalGasHPElecBackupMixed()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/LargeHotel-BTAPPRE1980-NaturalGasHPElecBackupMixed_CAN_AB_Calgary_diffs.json"
