...
class Test_MidriseApartment_BTAPPRE1980_NaturalGasHPGasBackup < NECBRegressionHelper
  ...
  def test_BTAPPRE1980_MidriseApartment_regression_NaturalGasHPGasBackup()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/MidriseApartment-BTAPPRE1980-NaturalGasHPGasBackup_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
