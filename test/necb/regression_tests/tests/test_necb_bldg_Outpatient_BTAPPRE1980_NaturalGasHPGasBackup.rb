...
class Test_Outpatient_BTAPPRE1980_NaturalGasHPGasBackup < NECBRegressionHelper
  ...
  def test_BTAPPRE1980_Outpatient_regression_NaturalGasHPGasBackup()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/Outpatient-BTAPPRE1980-NaturalGasHPGasBackup_CAN_AB_Calgary_diffs.json"
