...
class Test_SecondarySchool_BTAP1980TO2010_ElectricityHPGasBackupMixed < NECBRegressionHelper
  ...
  def test_BTAP1980TO2010_SecondarySchool_regression_ElectricityHPGasBackupMixed()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/SecondarySchool-BTAP1980TO2010-ElectricityHPGasBackupMixed_CAN_AB_Calgary_diffs.json"
