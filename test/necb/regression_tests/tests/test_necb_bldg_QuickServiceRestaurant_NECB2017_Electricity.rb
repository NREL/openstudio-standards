...
class Test_QuickServiceRestaurant_NECB2017_Electricity < NECBRegressionHelper
  ...
  def test_NECB2017_QuickServiceRestaurant_regression_Electricity()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/QuickServiceRestaurant-NECB2017-Electricity_CAN_AB_Calgary_diffs.json"
