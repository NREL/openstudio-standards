...
class Test_MidriseApartment_BTAPPRE1980_ElectricityHPElecBackup < NECBRegressionHelper
  ...
  def test_BTAPPRE1980_MidriseApartment_regression_ElectricityHPElecBackup()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/MidriseApartment-BTAPPRE1980-ElectricityHPElecBackup_CAN_AB_Calgary_diffs.json"
