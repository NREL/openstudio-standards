...
class Test_SmallOffice_NECB2015_ElectricityHPGasBackupMixed < NECBRegressionHelper
  ...
  def test_NECB2015_SmallOffice_regression_ElectricityHPGasBackupMixed()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/SmallOffice-NECB2015-ElectricityHPGasBackupMixed_CAN_AB_Calgary_diffs.json"
