...
class Test_SmallOffice_NECB2020_ElectricityHPGasBackupMixed < NECBRegressionHelper
  ...
  def test_NECB2020_SmallOffice_regression_ElectricityHPGasBackupMixed()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/SmallOffice-NECB2020-ElectricityHPGasBackupMixed_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
