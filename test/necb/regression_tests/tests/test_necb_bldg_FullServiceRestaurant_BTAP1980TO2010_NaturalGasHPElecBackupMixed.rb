...
class Test_FullServiceRestaurant_BTAP1980TO2010_NaturalGasHPElecBackupMixed < NECBRegressionHelper
  ...
  def test_BTAP1980TO2010_FullServiceRestaurant_regression_NaturalGasHPElecBackupMixed()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/FullServiceRestaurant-BTAP1980TO2010-NaturalGasHPElecBackupMixed_CAN_AB_Calgary_diffs.json"
