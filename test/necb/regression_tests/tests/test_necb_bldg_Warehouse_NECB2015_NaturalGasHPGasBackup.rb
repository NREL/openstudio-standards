...
class Test_Warehouse_NECB2015_NaturalGasHPGasBackup < NECBRegressionHelper
  ...
  def test_NECB2015_Warehouse_regression_NaturalGasHPGasBackup()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/Warehouse-NECB2015-NaturalGasHPGasBackup_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
