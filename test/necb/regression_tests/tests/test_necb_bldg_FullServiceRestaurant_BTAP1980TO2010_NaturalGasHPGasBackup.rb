...
class Test_FullServiceRestaurant_BTAP1980TO2010_NaturalGasHPGasBackup < NECBRegressionHelper
  ...
  def test_BTAP1980TO2010_FullServiceRestaurant_regression_NaturalGasHPGasBackup()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/FullServiceRestaurant-BTAP1980TO2010-NaturalGasHPGasBackup_CAN_AB_Calgary_diffs.json"
