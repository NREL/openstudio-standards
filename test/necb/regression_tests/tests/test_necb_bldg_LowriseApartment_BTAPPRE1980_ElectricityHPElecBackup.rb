...
class Test_LowriseApartment_BTAPPRE1980_ElectricityHPElecBackup < NECBRegressionHelper
  ...
  def test_BTAPPRE1980_LowriseApartment_regression_ElectricityHPElecBackup()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/LowriseApartment-BTAPPRE1980-ElectricityHPElecBackup_CAN_AB_Calgary_diffs.json"
