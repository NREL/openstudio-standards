...
class Test_HighriseApartment_BTAP1980TO2010_ElectricityHPGasBackupMixed < NECBRegressionHelper
  def setup()
    super()
  end
  ...
  def test_BTAP1980TO2010_HighriseApartment_regression_ElectricityHPGasBackupMixed()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/HighriseApartment-BTAP1980TO2010-ElectricityHPGasBackupMixed_CAN_AB_Calgary_diffs.json"
