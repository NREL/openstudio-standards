...
class Test_MidriseApartment_NECB2020_NaturalGasHPGasBackup < NECBRegressionHelper
  ...
  def test_NECB2020_MidriseApartment_regression_NaturalGasHPGasBackup()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_tests/expected/MidriseApartment-NECB2020-NaturalGasHPGasBackup_CAN_AB_Calgary_diffs.json"
