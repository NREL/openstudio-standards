...
class Test_MidriseApartment_NECB2017_NaturalGasHPElecBackupMixed < NECBRegressionHelper
  ...
  def test_NECB2017_MidriseApartment_regression_NaturalGasHPElecBackupMixed()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/MidriseApartment-NECB2017-NaturalGasHPElecBackupMixed_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
