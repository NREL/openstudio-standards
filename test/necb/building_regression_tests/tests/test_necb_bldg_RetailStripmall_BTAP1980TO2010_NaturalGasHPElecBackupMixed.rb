...
class Test_RetailStripmall_BTAP1980TO2010_NaturalGasHPElecBackupMixed < NECBRegressionHelper
  ...
  def test_BTAP1980TO2010_RetailStripmall_regression_NaturalGasHPElecBackupMixed()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/RetailStripmall-BTAP1980TO2010-NaturalGasHPElecBackupMixed_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
