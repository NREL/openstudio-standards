...
class Test_HighriseApartment_NECB2017_electric < NECBRegressionHelper
  def setup()
    super()
  end
  def test_NECB2017_HighriseApartment_regression_electric()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_models/HighriseApartment-NECB2017-#\{@electric_location\%>.epw_diffs.json"
