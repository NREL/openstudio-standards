...
class Test_SmallHotel_NECB2015_gas < NECBRegressionHelper
  def setup()
    super()
  end
  def test_NECB2015_SmallHotel_regression_gas()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/regression_models/SmallHotel-NECB2015-#\{@gas_location\%>.epw_diffs.json"
