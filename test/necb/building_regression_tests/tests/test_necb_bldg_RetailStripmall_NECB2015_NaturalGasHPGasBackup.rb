...
class Test_RetailStripmall_NECB2015_NaturalGasHPGasBackup < NECBRegressionHelper
  ...
  def test_NECB2015_RetailStripmall_regression_NaturalGasHPGasBackup()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/RetailStripmall-NECB2015-NaturalGasHPGasBackup_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
