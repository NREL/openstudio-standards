...
class Test_LowriseApartment_NECB2011_NaturalGasHPGasBackup < NECBRegressionHelper
  ...
  def test_NECB2011_LowriseApartment_regression_NaturalGasHPGasBackup()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/LowriseApartment-NECB2011-NaturalGasHPGasBackup_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
