...
class Test_RetailStripmall_NECB2011_Electricity < NECBRegressionHelper
  ...
  def test_NECB2011_RetailStripmall_regression_Electricity()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/RetailStripmall-NECB2011-Electricity_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
