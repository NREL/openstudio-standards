...
class Test_HighriseApartment_NECB2020_ElectricityHPElecBackup < NECBRegressionHelper
  ...
  def test_NECB2020_HighriseApartment_regression_ElectricityHPElecBackup()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/HighriseApartment-NECB2020-ElectricityHPElecBackup_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
