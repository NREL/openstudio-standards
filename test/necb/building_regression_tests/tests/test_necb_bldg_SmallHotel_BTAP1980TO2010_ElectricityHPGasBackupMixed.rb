...
class Test_SmallHotel_BTAP1980TO2010_ElectricityHPGasBackupMixed < NECBRegressionHelper
  ...
  def test_BTAP1980TO2010_SmallHotel_regression_ElectricityHPGasBackupMixed()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/SmallHotel-BTAP1980TO2010-ElectricityHPGasBackupMixed_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
