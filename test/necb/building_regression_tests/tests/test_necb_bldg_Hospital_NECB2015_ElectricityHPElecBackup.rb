...
class Test_Hospital_NECB2015_ElectricityHPElecBackup < NECBRegressionHelper
  ...
  def test_NECB2015_Hospital_regression_ElectricityHPElecBackup()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/Hospital-NECB2015-ElectricityHPElecBackup_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
