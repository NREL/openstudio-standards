...
class Test_LargeOffice_NECB2015_Electricity < NECBRegressionHelper
  ...
  def test_NECB2015_LargeOffice_regression_Electricity()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/LargeOffice-NECB2015-Electricity_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
