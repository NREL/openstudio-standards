...
puts "You can find the saved json diff file here test/necb/regression_models/FullServiceRestaurant-NECB2011-Electricity_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
