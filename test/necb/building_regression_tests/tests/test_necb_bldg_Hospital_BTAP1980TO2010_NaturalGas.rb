...
class Test_Hospital_BTAP1980TO2010_NaturalGas < NECBRegressionHelper
  ...
  def test_BTAP1980TO2010_Hospital_regression_NaturalGas()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/Hospital-BTAP1980TO2010-NaturalGas_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
