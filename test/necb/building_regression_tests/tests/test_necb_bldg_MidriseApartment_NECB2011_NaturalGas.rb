...
class Test_MidriseApartment_NECB2011_NaturalGas < NECBRegressionHelper
  ...
  def test_NECB2011_MidriseApartment_regression_NaturalGas()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/MidriseApartment-NECB2011-NaturalGas_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
