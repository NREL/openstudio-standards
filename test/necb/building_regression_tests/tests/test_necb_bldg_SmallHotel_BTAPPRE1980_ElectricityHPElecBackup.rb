...
class Test_SmallHotel_BTAPPRE1980_ElectricityHPElecBackup < NECBRegressionHelper
  ...
  def test_BTAPPRE1980_SmallHotel_regression_ElectricityHPElecBackup()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/SmallHotel-BTAPPRE1980-ElectricityHPElecBackup_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
