...
class Test_MediumOffice_NECB2017_Electricity < NECBRegressionHelper
  ...
  def test_NECB2017_MediumOffice_regression_Electricity()
    ...
    if result == false
      ...
      puts "You can find the saved json diff file here test/necb/building_regression_tests/expected_results/MediumOffice-NECB2017-Electricity_CAN_AB_Calgary.Intl.AP.718770_CWEC2020_diffs.json"
