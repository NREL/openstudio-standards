...
class GeneratorNECBTests
  # default loation circleci_tests.txt file when run on

  def initialize()
    @file_out_dir = File.absolute_path(File.join(__FILE__, "..", "..", "generated_tests"))
    @necb_bldg_dir = File.absolute_path(File.join(@file_out_dir, 'necb_bldg'))

    reset_folder(@necb_system_dir)
  end
  ...
  def generate_necb_bldg_test_files
    ...
    necb_bldg_template = File.read("/home/osdev/openstudio-standards/test/necb/templates/template_test_necb_bldg.erb")
    filenames = []
    templates.each {|template|
      building_types.each {|building_type|
        fuel_types.each {|fuel_type|
          filename = File.join(@necb_bldg_dir, "test_necb_bldg_#{building_type}_#{template}_#{fuel_type}.rb")
  ...
  def generate_hvac_system_1_test_files(verbose = true)
    necb_system_template = File.read("/home/osdev/openstudio-standards/test/necb/templates/template_test_necb_system_1.rb")
    systems = [
        {
            name: 'system_1',
        ...
        system[:mau_types].each do |mau_type|
          system[:mau_heating_coil_types].each do |mau_heating_coil_type|
            system[:baseboard_types].each do |baseboard_type|
              ...
              filename = File.join(@necb_system_dir, "#{test_name}.rb")
  ...
  def generate_hvac_system_2_and_5_test_files(verbose = true)
    reset_folder(@necb_system_dir)
    necb_system_template = File.read("/home/osdev/openstudio-standards/test/necb/templates/template_test_necb_system_2_and_5.rb")
    systems = [
        {
            name: 'system_2',
            boiler_fuel_types: ["NaturalGas", "Electricity", "FuelOil#2"],
  ...
  def generate_hvac_system_3_test_files(verbose = true)
    necb_system_template = File.read("/home/osdev/openstudio-standards/test/necb/templates/template_test_necb_system_3.rb")
    systems = [
        {
            name: 'system_3',
            boiler_fuel_types: ["NaturalGas", "Electricity", "FuelOil#2"],
  ...
  def generate_hvac_system_4_test_files(verbose = true)
    necb_system_template = File.read("/home/osdev/openstudio-standards/test/necb/templates/template_test_necb_system_4.rb")
    systems = [
        {
            name: 'system_4',
            boiler_fuel_types: ["NaturalGas", "Electricity", "FuelOil#2"],
  ...
  def generate_hvac_system_6_test_files(verbose = true)
    necb_system_template = File.read("/home/osdev/openstudio-standards/test/necb/templates/template_test_necb_system_6.rb")
    systems = [
        {
            name: 'system_6',
            boiler_fuel_types: ["NaturalGas", "Electricity", "FuelOil#2"],
...
GeneratorNECBRegressionTests.new.generate_necb_bldg_test_files
GeneratorNECBRegressionTests.new.generate_hvac_system_2_and_5_test_files
GeneratorNECBRegressionTests.new.generate_hvac_system_1_test_files
GeneratorNECBRegressionTests.new.generate_hvac_system_3_test_files
GeneratorNECBRegressionTests.new.generate_hvac_system_4_test_files
GeneratorNECBRegressionTests.new.generate_hvac_system_6_test_files
