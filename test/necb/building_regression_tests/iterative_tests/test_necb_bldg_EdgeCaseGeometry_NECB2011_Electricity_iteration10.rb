...
class Test_EdgeCaseGeometry_NECB2011_Electricity_iteration10 < NECBRegressionHelper 

  def setup()
    super()
  end

  def test_NECB2011_EdgeCaseGeometry_regression_Electricity_iteration10()
