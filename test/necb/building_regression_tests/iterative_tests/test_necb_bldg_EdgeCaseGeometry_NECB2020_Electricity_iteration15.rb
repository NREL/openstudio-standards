...
class Test_EdgeCaseGeometry_NECB2020_Electricity_iteration15 < NECBRegressionHelper 

  def setup()
    super()
  end

  def test_NECB2020_EdgeCaseGeometry_regression_Electricity_iteration15()
