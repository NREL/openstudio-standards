...
class Test_EdgeCaseGeometry_NECB2015_Electricity_iteration16 < NECBRegressionHelper 

  def setup()
    super()
  end

  def test_NECB2015_EdgeCaseGeometry_regression_Electricity_iteration16()
