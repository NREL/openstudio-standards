...
class Test_EdgeCaseGeometry_NECB2017_Electricity_iteration13 < NECBRegressionHelper 

  def setup()
    super()
  end

  def test_NECB2017_EdgeCaseGeometry_regression_Electricity_iteration13()
