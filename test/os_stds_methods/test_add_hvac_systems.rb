...
class TestAddHVACSystems < Minitest::Test
  ...
  def model_hvac_test(hvac_arguments)
    ...
    unless annual_run_success
      ...
      if zone_selection == 'heated_zones'
        zones = heated_zones
      elsif zone_selection == 'cooled_zones'
        zones = cooled_zones
      elsif zone_selection == 'heated_only_zones'
        zones = heated_only_zones
      elsif zone_selection == 'cooled_only_zones'
  ...
  def test_add_hvac_systems_sz_heating
    hvac_systems = [
      {system_type: 'Baseboards', main_heat_fuel: 'Electricity', zone_selection: 'heated_zones', unmet_hrs_clg: 6000.0},
      {system_type: 'Baseboards', main_heat_fuel: 'NaturalGas', zone_selection: 'heated_zones', unmet_hrs_clg: 6000.0},
      {system_type: 'Baseboards', main_heat_fuel: 'AirSourceHeatPump', zone_selection: 'heated_zones', unmet_hrs_clg: 6000.0},
      {system_type: 'Baseboards', main_heat_fuel: 'DistrictHeating', zone_selection: 'heated_zones', unmet_hrs_clg: 6000.0},
      ...
      {system_type: 'Forced Air Furnace', main_heat_fuel: 'NaturalGas', zone_selection: 'heated_zones', unmet_hrs_clg: 6000.0}
    ]
    group_hvac_test(hvac_systems)
  end
  ...
  def test_add_hvac_systems_sz_cooling
    hvac_systems = [
      {system_type: 'Evaporative Cooler', cool_fuel: 'Electricity', zones: 'cooled_zones', climate_zone: 'ASHRAE 169-2013-2B', unmet_hrs_htg: 6000.0},
    ]
  ...
  def test_add_hvac_systems_ptac_pthp
    hvac_systems = [
      {system_type: 'PTAC', main_heat_fuel: 'Electricity', cool_fuel: 'Electricity'},
      {system_type: 'PTAC', main_heat_fuel: 'NaturalGas', cool_fuel: 'Electricity'},
      {system_type: 'PTAC', main_heat_fuel: 'AirSourceHeatPump', cool_fuel: 'Electricity'},
      {system_type: 'PTAC', main_heat_fuel: 'DistrictHeating', cool_fuel: 'Electricity'},
      {system_type: 'PTAC', main_heat_fuel: nil, cool_fuel: 'Electricity'},
  ...
  def test_add_hvac_systems_pszac_pszhp
    hvac_systems = [
      {system_type: 'PSZ-AC', main_heat_fuel: 'Electricity', cool_fuel: 'Electricity'},
      {system_type: 'PSZ-AC', main_heat_fuel: 'Electricity', cool_fuel: 'DistrictCooling'},
      {system_type: 'PSZ-AC', main_heat_fuel: 'NaturalGas', cool_fuel: 'Electricity'},
      {system_type: 'PSZ-AC', main_heat_fuel: 'NaturalGas', cool_fuel: 'DistrictCooling'},
      {system_type: 'PSZ-AC', main_heat_fuel: 'AirSourceHeatPump', cool_fuel: 'Electricity'},
      {system_type: 'PSZ-AC', main_heat_fuel: 'AirSourceHeatPump', cool_fuel: 'DistrictCooling'},
      {system_type: 'PSZ-AC', main_heat_fuel: 'DistrictHeating', cool_fuel: 'Electricity'},
      {system_type: 'PSZ-AC', main_heat_fuel: 'DistrictHeating', cool_fuel: 'DistrictCooling'},
      {system_type: 'PSZ-AC', main_heat_fuel: nil, cool_fuel: 'Electricity'},
      {system_type: 'PSZ-AC', main_heat_fuel: nil, cool_fuel: 'DistrictCooling'},
  ...
  def test_add_hvac_systems_fan_coil
    hvac_systems = [
      {system_type: 'Fan Coil', main_heat_fuel: 'Electricity', cool_fuel: 'Electricity', chilled_water_loop_cooling_type: 'Water_Cooled'},
      {system_type: 'Fan Coil', main_heat_fuel: 'Electricity', cool_fuel: 'Electricity', chilled_water_loop_cooling_type: 'AirCooled'},
      {system_type: 'Fan Coil', main_heat_fuel: 'Electricity', cool_fuel: 'DistrictCooling'},
      {system_type: 'Fan Coil', main_heat_fuel: 'NaturalGas', cool_fuel: 'Electricity', chilled_water_loop_cooling_type: 'Water_Cooled'},
      {system_type: 'Fan Coil', main_heat_fuel: 'NaturalGas', cool_fuel: 'Electricity', chilled_water_loop_cooling_type: 'AirCooled'},
      {system_type: 'Fan Coil', main_heat_fuel: 'NaturalGas', cool_fuel: 'DistrictCooling'},
      {system_type: 'Fan Coil', main_heat_fuel: 'AirSourceHeatPump', cool_fuel: 'Electricity', chilled_water_loop_cooling_type: 'Water_Cooled'},
      {system_type: 'Fan Coil', main_heat_fuel: 'AirSourceHeatPump', cool_fuel: 'Electricity', chilled_water_loop_cooling_type: 'AirCooled'},
      {system_type: 'Fan Coil', main_heat_fuel: 'AirSourceHeatPump', cool_fuel: 'DistrictCooling'},
      {system_type: 'Fan Coil', main_heat_fuel: 'DistrictHeating', cool_fuel: 'Electricity', chilled_water_loop_cooling_type: 'Water_Cooled'},
      {system_type: 'Fan Coil', main_heat_fuel: 'DistrictHeating', cool_fuel: 'Electricity', chilled_water_loop_cooling_type: 'AirCooled'},
      {system_type: 'Fan Coil', main_heat_fuel: 'DistrictHeating', cool_fuel: 'DistrictCooling'}
    ]
    group_hvac_test(hvac_systems)
  end
  ...
  def test_add_hvac_systems_wshp
    hvac_systems = [
      {system_type: 'Water Source Heat Pumps', main_heat_fuel: 'Electricity', cool_fuel: 'Electricity', heat_pump_loop_cooling_type: 'CoolingTower'},
      {system_type: 'Water Source Heat Pumps', main_heat_fuel: 'Electricity', cool_fuel: 'Electricity', heat_pump_loop_cooling_type: 'FluidCooler'},
      {system_type: 'Water Source Heat Pumps', main_heat_fuel: 'NaturalGas', cool_fuel: 'Electricity', heat_pump_loop_cooling_type: 'CoolingTower'},
      {system_type: 'Water Source Heat Pumps', main_heat_fuel: 'NaturalGas', cool_fuel: 'Electricity', heat_pump_loop_cooling_type: 'FluidCooler'},
      {system_type: 'Water Source Heat Pumps', main_heat_fuel: 'AirSourceHeatPump', cool_fuel: 'Electricity', heat_pump_loop_cooling_type: 'CoolingTower'},
      {system_type: 'Water Source Heat Pumps', main_heat_fuel: 'AirSourceHeatPump', cool_fuel: 'Electricity', heat_pump_loop_cooling_type: 'FluidCooler'},
      {system_type: 'Water Source Heat Pumps', main_heat_fuel: 'DistrictHeating', cool_fuel: 'Electricity', heat_pump_loop_cooling_type: 'CoolingTower'},
      {system_type: 'Water Source Heat Pumps', main_heat_fuel: 'DistrictHeating', cool_fuel: 'Electricity', heat_pump_loop_cooling_type: 'FluidCooler'},
      {system_type: 'Water Source Heat Pumps', main_heat_fuel: 'AmbientLoop', cool_fuel: 'AmbientLoop', heat_pump_loop_cooling_type: 'CoolingTower'},
      {system_type: 'Water Source Heat Pumps', main_heat_fuel: 'AmbientLoop', cool_fuel: 'AmbientLoop', heat_pump_loop_cooling_type: 'FluidCooler'}
    ]
    group_hvac_test(hvac_systems)
  end
  ...
  def test_add_hvac_systems_vav
    hvac_systems = [
      {system_type: 'PVAV Reheat', main_heat_fuel: 'NaturalGas', zone_heat_fuel: 'Electricity', cool_fuel: 'Electricity'},
      {system_type: 'PVAV Reheat', main_heat_fuel: 'NaturalGas', zone_heat_fuel: 'NaturalGas', cool_fuel: 'Electricity'},
      {system_type: 'PVAV Reheat', main_heat_fuel: 'AirSourceHeatPump', zone_heat_fuel: 'AirSourceHeatPump', cool_fuel: 'Electricity'},
      ...
      {system_type: 'VAV Reheat', main_heat_fuel: 'AirSourceHeatPump', zone_heat_fuel: 'NaturalGas', cool_fuel: 'Electricity'},
      ...
      {system_type: 'VAV PFP Boxes', main_heat_fuel: 'NaturalGas', zone_heat_fuel: 'Electricity', cool_fuel: 'Electricity'},
      {system_type: 'VAV PFP Boxes', main_heat_fuel: 'AirSourceHeatPump', zone_heat_fuel: 'Electricity', cool_fuel: 'Electricity'},
      {system_type: 'VAV PFP Boxes', main_heat_fuel: 'DistrictHeating', zone_heat_fuel: 'Electricity', cool_fuel: 'DistrictCooling'},
      {system_type: 'VAV PFP Boxes', main_heat_fuel: 'AirSourceHeatPump', zone_heat_fuel: 'Electricity', cool_fuel: 'Electricity'},
      {system_type: 'VAV PFP Boxes', main_heat_fuel: 'DistrictHeating', zone_heat_fuel: 'Electricity', cool_fuel: 'DistrictCooling'},
      {system_type: 'VAV Gas Reheat', main_heat_fuel: 'NaturalGas', zone_heat_fuel: 'NaturalGas', cool_fuel: 'Electricity'},
      {system_type: 'VAV Gas Reheat', main_heat_fuel: 'AirSourceHeatPump', zone_heat_fuel: 'NaturalGas', cool_fuel: 'Electricity'},
      {system_type: 'VAV Gas Reheat', main_heat_fuel: 'DistrictHeating', zone_heat_fuel: 'NaturalGas', cool_fuel: 'Electricity'},
      {system_type: 'VAV Gas Reheat', main_heat_fuel: 'DistrictHeating', zone_heat_fuel: 'NaturalGas', cool_fuel: 'DistrictCooling'},
      {system_type: 'VAV No Reheat', main_heat_fuel: 'NaturalGas', zone_heat_fuel: nil, cool_fuel: 'Electricity', zones: 'cooled_zones'}
    ]
    group_hvac_test(hvac_systems)
  end
  ...
  def test_add_hvac_systems_doas
    hvac_systems = [
      ...
      {system_type: 'Fan Coil with DOAS', main_heat_fuel: 'Electricity', cool_fuel: 'Electricity', chilled_water_loop_cooling_type: 'AirCooled'},
      ...
      {system_type: 'Water Source Heat Pumps with DOAS', main_heat_fuel: 'Electricity', cool_fuel: 'Electricity', heat_pump_loop_cooling_type: 'FluidCooler'},
  ...
  def test_add_hvac_systems_doas_dcv
    hvac_systems = [
      ...
      {system_type: 'Fan Coil with DOAS with DCV', main_heat_fuel: 'Electricity', cool_fuel: 'Electricity', chilled_water_loop_cooling_type: 'AirCooled'}
    ]
    group_hvac_test(hvac_systems)
  end
  ...
  def test_add_hvac_systems_ervs
    hvac_systems = [
        ...
        {system_type: 'Fan Coil with ERVs', main_heat_fuel: 'Electricity', cool_fuel: 'Electricity', chilled_water_loop_cooling_type: 'AirCooled'},
        ...
        {system_type: 'Water Source Heat Pumps with ERVs', main_heat_fuel: 'Electricity', cool_fuel: 'Electricity', heat_pump_loop_cooling_type: 'FluidCooler'},
