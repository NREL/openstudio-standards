...
class TestRadiantControls < Minitest::Test
  ...
  def test_radiant_precool_hours_schedule
    arguments = {model_test_name: 'radiant_precool_hours_schedule', main_heat_fuel: 'NaturalGas', cool_fuel: 'Electricity',
       ...
       unmet_hrs_htg: 200.0, unmet_hrs_clg: 1500.0}
  ...
  def test_radiant_afternoon_shutoff_hours_schedule
    arguments = {model_test_name: 'radiant_afternoon_shutoff_hours_schedule', main_heat_fuel: 'NaturalGas', cool_fuel: 'Electricity',
       hot_water_loop_type: 'LowTemperature', climate_zone: 'ASHRAE 169-2013-5B', model_name: 'basic_2_story_office_no_hvac_20WWR',
       radiant_type: 'ceiling', use_zone_occupancy_for_control: false, radiant_availability_type: 'afternoon_shutoff',
       custom_variables_output: [['Zone Radiant HVAC Heating Rate', '*', 'Hourly'], ['Zone Radiant HVAC Cooling Rate', '*', 'Hourly']],
       unmet_hrs_htg: 150.0, unmet_hrs_clg: 1250.0}
    ...
    # radiant lockout hours for precool operation
    radiant_lockout_start_time = 15.0
    radiant_lockout_end_time = 22.0
  ...
  def test_radiant_all_day_hours_schedule
    arguments = {model_test_name: 'radiant_all_day_hours_schedule', main_heat_fuel: 'NaturalGas', cool_fuel: 'Electricity',
       hot_water_loop_type: 'LowTemperature', climate_zone: 'ASHRAE 169-2013-5B', model_name: 'basic_2_story_office_no_hvac_20WWR',
       radiant_type: 'ceiling', use_zone_occupancy_for_control: false, radiant_availability_type: 'all_day',
       custom_variables_output: [['Zone Radiant HVAC Heating Rate', '*', 'Hourly'], ['Zone Radiant HVAC Cooling Rate', '*', 'Hourly']],
       unmet_hrs_htg: 100.0, unmet_hrs_clg: 1500.0}
    ...
    # radiant lockout hours for precool operation
    radiant_lockout_start_time = 24.0
    radiant_lockout_end_time = 24.0
