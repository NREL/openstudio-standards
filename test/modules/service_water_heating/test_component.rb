...
class TestServiceWaterHeatingComponent < Minitest::Test
  ...
  def test_add_pumped_hpwh_ems
    ...
    hpwh = @swh.model_add_heatpump_water_heater(model,
    ...
    output_dir = "#{__dir__}/output/test_add_pumped_hpwh_ems"
  ...
  def test_add_wrapped_hpwh_ems
    ...
    # set output directory
    output_dir = "#{__dir__}/output/test_add_wrapped_hpwh_ems"
    FileUtils.mkdir output_dir unless Dir.exist? output_dir
  ...
  def test_add_wrapped_hpwh_no_ems
    ...
    # set output directory
    output_dir = "#{__dir__}/output/test_add_wrapped_hpwh_no_ems"
    FileUtils.mkdir output_dir unless Dir.exist? output_dir
