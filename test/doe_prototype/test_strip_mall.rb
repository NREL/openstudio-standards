...
class TestStripMall < CreateDOEPrototypeBuildingTest
  ...
  climate_zones = ['ASHRAE 169-2A','ASHRAE 169-3B','ASHRAE 169-5A','ASHRAE 169-8A']
  ...
  # TestStripMall.compare_test_results(building_types, templates, climate_zones, file_ext="")
end
