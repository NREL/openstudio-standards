...
class TestAddExteriorLights < Minitest::Test
  ...
  def test_add_exterior_lights_small_hotel
    ...
    assert_in_delta(17.28,exterior_lights["Main Entries"].multiplier,1.0) #  8 ft per entry * 2 entries per * 43,202 ft^2  / 10,000 ft^2
    assert_in_delta(124.9,exterior_lights["Other Doors"].multiplier,1.0) #  4 ft per entry * 28.91 entries per * 43,202 ft^2  / 10,000 ft^2
