...
class TestLaboratory < CreateDOEPrototypeBuildingTest
  building_types = ['Laboratory']
  ...
  debug = false
  TestLaboratory.create_run_model_tests(building_types, templates, climate_zones, epw_files, create_models, run_models, compare_results, debug)
end
