...
class TestTallBuilding < CreateDOEPrototypeBuildingTest
  ...
  TestTallBuilding.create_run_model_tests(building_types, templates, climate_zones, epw_files, create_models, run_models, compare_results, debug, additional_params: additional_params)
end
