...
class TestRt3 < CreateDEERPrototypeBuildingTest
  ...
  TestRt3.create_run_model_tests(building_types, templates, hvacs, climate_zones, create_models, run_models, compare_results, debug)
