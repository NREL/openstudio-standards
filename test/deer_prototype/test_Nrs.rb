...
class TestNrs < CreateDEERPrototypeBuildingTest
  
  building_types = ['Nrs']
  templates = ['DEER Pre-1975']
  hvacs = ['DXEH'] # , 'DXGF', 'DXHP', 'FPFC', 'NCEH', 'NCGF', 'PVVE', 'PVVG', 'SVVE', 'SVVG']
  ...
  TestNrs.create_run_model_tests(building_types, templates, hvacs, climate_zones, create_models, run_models, compare_results, debug)
