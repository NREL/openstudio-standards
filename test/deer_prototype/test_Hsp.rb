...
class TestHsp < CreateDEERPrototypeBuildingTest
  
  building_types = ['Hsp']
  templates = ['DEER Pre-1975']
  hvacs = ['DXEH'] # , 'DXGF', 'DXHP', 'NCEH', 'NCGF', 'PVVE', 'PVVG', 'SVVE', 'SVVG']
  ...
  TestHsp.create_run_model_tests(building_types, templates, hvacs, climate_zones, create_models, run_models, compare_results, debug)
