...
class Baseline9012013Test3 < Minitest::Test
  ...
  def test_dhw_bldg2_electric
    ...
    model = create_baseline_model('bldg_2', '90.1-2013', 'ASHRAE 169-5B', building_type, 'Xcel Energy CO EDA', false, true)
    failure_array = []
  ...
  def test_dhw_bldg2_naturalgas
    ...
    model = create_baseline_model('bldg_2', '90.1-2013', 'ASHRAE 169-4B', building_type, 'Xcel Energy CO EDA', false, true)
    failure_array = []
  ...
  def known_fail_test_dcv_bldg3
    ...
    model = create_baseline_model('bldg_3_LockerOtherDCV', '90.1-2013', 'ASHRAE 169-5B', 'MediumOffice', 'Xcel Energy CO EDA', false, true)
    failure_array = []
  ...
  def test_erv_bldg3
    ...
    model = create_baseline_model('bldg_3', '90.1-2013', 'ASHRAE 169-6B', 'MediumOffice', 'Xcel Energy CO EDA', false, true)
    failure_array = []
  ...
  def test_non_predominant_heating_condition_bldg_2
    ...
    model = create_baseline_model('bldg_2_NonPredominantHeating', '90.1-2013', 'ASHRAE 169-5B', 'MediumOffice', 'Xcel Energy CO EDA', false, true)
    failure_array = []
  ...
  def test_economizing_bldg2_1A
    ...
    model = create_baseline_model('bldg_2', '90.1-2013', 'ASHRAE 169-1A', 'MediumOffice', 'Xcel Energy CO EDA', false, true)
    failure_array = []
  ...
  def test_economizing_bldg2_5A
    ...
    model = create_baseline_model('bldg_2', '90.1-2013', 'ASHRAE 169-5A', 'MediumOffice', 'Xcel Energy CO EDA', false, true)
    failure_array = []
  ...
  def test_design_supply_air_temp_bldg2_thermostat_mod
    model = create_baseline_model('bldg_2_thermostat_mod', '90.1-2013', 'ASHRAE 169-5B', 'MediumOffice', 'Xcel Energy CO EDA', false, true)
    failure_array = []
