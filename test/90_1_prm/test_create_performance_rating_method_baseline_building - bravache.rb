...
def create_baseline_model(model_name, standard, climate_zone, building_type, debug)
  ...
  # 'ASHRAE 169-6A', 'ASHRAE 169-6B', 'ASHRAE 169-7A',
...
class TestRun12 < Minitest::Test
	...
	@@model = create_baseline_model('Run12_Prototype', '90.1-2010', 'ASHRAE 169-2A', 'MediumOffice', false)
...
class TestRun01 < Minitest::Test
	...
	@@model = create_baseline_model('Run01_Prototype', '90.1-2010', 'ASHRAE 169-2A', 'SmallOffice', false)
...
class TestRun18 < Minitest::Test
	...
	@@model = create_baseline_model('Run18_Prototype', '90.1-2010', 'ASHRAE 169-2A', 'SmallOffice', false)
