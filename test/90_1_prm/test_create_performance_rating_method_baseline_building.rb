...
class Baseline9012013Test < Minitest::Test
  ...
  def known_fail_test_bldg_9
    ...
    base_model = create_baseline_model('bldg_9', '90.1-2013', 'ASHRAE 169-5B', 'MidriseApartment', 'Xcel Energy CO EDA', false, true)
  ...
  def test_bldg_10_purchased_energy
    ...
    base_model = create_baseline_model(test_model_name, '90.1-2013', 'ASHRAE 169-5B', 'MediumOffice' ,'Xcel Energy CO EDA', false, true)
    prop_model = load_test_model(test_model_name)
  ...
  def test_bldg_11_num_boilers
    ...
    base_model = create_baseline_model(test_model_name, '90.1-2013', 'ASHRAE 169-5B', 'LargeOffice','Xcel Energy CO EDA', false, true)
    prop_model = load_test_model(test_model_name)
  ...
  def test_bldg_12_num_boilers
    ...
    base_model = create_baseline_model(test_model_name, '90.1-2013', 'ASHRAE 169-5B', 'MidriseApartment','Xcel Energy CO EDA', false, true)
    prop_model = load_test_model(test_model_name)
  ...
  def test_bldg_13_economizer
    ...
    base_model = create_baseline_model('bldg_13', '90.1-2013', 'ASHRAE 169-5B', 'SmallOffice','Xcel Energy CO EDA', false, true)
  ...
  def test_bldg_13_ventilation_rates
    ...
    base_model = create_baseline_model(test_model_name, '90.1-2013', 'ASHRAE 169-5B', 'SmallOffice','Xcel Energy CO EDA', false, true)
    prop_model = load_test_model(test_model_name)
  ...
  def test_bldg_14_coil_efficiencies
    ...
    base_model = create_baseline_model('bldg_14', '90.1-2013', 'ASHRAE 169-5B', 'Warehouse','Xcel Energy CO EDA', false, true)
    check_coil_efficiencies(base_model)
  ...
  def test_bldg_14_ventilation_rates
    ...
    base_model = create_baseline_model(test_model_name, '90.1-2013', 'ASHRAE 169-5B', 'Warehouse','Xcel Energy CO EDA', false, true)
    prop_model = load_test_model(test_model_name)
  ...
  def known_fail_test_bldg_15_retail_standalone
    ...
    model = create_baseline_model('bldg_15', '90.1-2013', 'ASHRAE 169-5B', 'RetailStandalone','Xcel Energy CO EDA', false, true)
  ...
  def known_fail_test_bldg_16_medium_office
    ...
    # Create the baseline model
    model = create_baseline_model('bldg_16', '90.1-2013', 'ASHRAE 169-5B', 'MediumOffice','Xcel Energy CO EDA', false, true)
  ...
  def known_fail_test_bldg_17_midrise_apartment_lowrise_iecc_constructions
    ...
    # Create the baseline model
    model = create_baseline_model('bldg_17', '90.1-2013', 'ASHRAE 169-5B', 'MidriseApartment','Xcel Energy CO EDA', false, true)
  ...
  def known_fail_test_bldg_18_retail_standalone
    ...
    # Create the baseline model
    model = create_baseline_model('bldg_18', '90.1-2013', 'ASHRAE 169-5B', 'RetailStandalone','Xcel Energy CO EDA', false, true)
  ...
  def known_fail_test_bldg_19_medium_office
    ...
    # Create the baseline model
    model = create_baseline_model('bldg_19', '90.1-2013', 'ASHRAE 169-5B', 'MediumOffice','Xcel Energy CO EDA', false, true)
  ...
  def known_fail_test_bldg_20_large_hotel
    ...
    # Create the baseline model
    model = create_baseline_model('bldg_20', '90.1-2013', 'ASHRAE 169-5B', 'LargeHotel','Xcel Energy CO EDA', false, true)
