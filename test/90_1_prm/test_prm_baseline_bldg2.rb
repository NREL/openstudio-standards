...
class Baseline9012013Test2 < Minitest::Test
  ...
  def test_lpd_bldg2 # disable this test, which succeeds locally but fails on circleci for no apparent reason
  ...
  # @author Matt Leach, NORESCO
  def test_system_type_bldg2 # This test fails on circleci but succeeds locally.  Cannot figure out why.
    model = create_baseline_model('bldg_2', '90.1-2013', 'ASHRAE 169-2006-5B', 'MediumOffice', 'Xcel Energy CO EDA', false, true)
    failure_array = []
