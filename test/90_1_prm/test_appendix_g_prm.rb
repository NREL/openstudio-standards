...
class AppendixGPRMTests < Minitest::Test
  ...
  # The baseline
  #
  # @param prototypes_generated [Array] List of all the unique prototypes for baseline generation
