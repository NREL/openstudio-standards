class Standard
  ...
  def model_create_fan_on_off_from_json(model, fan_json, fan_name:nil, fan_efficiency: nil, pressure_rise: nil,
    ...
    # create fan
    model_create_fan_on_off(model, fan_name:fan_name, fan_efficiency:fan_efficiency, pressure_rise:pressure_rise,
  ...
  def model_create_fan_on_off(model, fan_name:nil, fan_efficiency: nil, pressure_rise: nil, motor_efficiency: nil,
