class Standard
  ...
  def create_coil_heating_water(model, hot_water_loop, name: "Htg Coil", schedule: nil,
    ...
    hot_water_loop.addDemandBranchForComponent(clg_coil)
    ...
    # defaults
    htg_coil.setHeatExchangerConfiguration('CrossFlow')

    # coil controller properties
    htg_coil_controller = clg_coil.controllerWaterCoil.get
