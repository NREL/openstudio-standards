    ...
    if type == 'OS default'
      ...
      if model.version < OpenStudio::VersionString.new('3.2.0')
        ...
        if model.getCurveByName('Water to Air Heat Pump Heating Power Consumption Curve').is_initialized
          ...
          heating_power_consumption_curve.setCoefficient1Constant(0.237847462869254)
          heating_power_consumption_curve.setCoefficient2w(-3.35823796081626)
          heating_power_consumption_curve.setCoefficient3x(3.80640467406376)
          heating_power_consumption_curve.setCoefficient4y(0.179200417311554)
          heating_power_consumption_curve.setCoefficient5z(0.12860719846082)
