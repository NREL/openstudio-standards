class StandardsModel
  ...
  def model_add_refrigeration_case(model, case_type, case_name, length, thermal_zone)
    ...
    props = model_find_object($os_standards['refrigerated_cases'], search_criteria)
    if props.nil?
  ...
  def model_add_refrigeration_walkin(model, walkin_type, walkin_name, insulated_floor_area, thermal_zone)
    ...
    props = model_find_object($os_standards['walkin_refrigeration'], search_criteria)
    if props.nil?
  ...
  def model_add_refrigeration_compressor(model, compressor_type)
    ...
    props = model_find_object($os_standards['refrigeration_compressors'], search_criteria)
    if props.nil?
