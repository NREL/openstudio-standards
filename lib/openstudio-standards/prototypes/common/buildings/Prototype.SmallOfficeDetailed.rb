...
module SmallOfficeDetailed
  def model_custom_hvac_tweaks(building_type, climate_zone, prototype_input, model)
    ...
    add_attic_infiltration(climate_zone, model)
 ...
 entry_space = model.getSpaceByName('Lobby').get
      ...
      if template == '90.1-2004'
        infiltration_per_zone_entrydoor = 0.1297854
        ...
        case climate_zone
        when 'ASHRAE 169-2006-1A', 'ASHRAE 169-2006-2A', 'ASHRAE 169-2006-3A', 'ASHRAE 169-2006-4A', 'ASHRAE 169-2006-1B', 'ASHRAE 169-2006-2B', 'ASHRAE 169-2006-3B', 'ASHRAE 169-2006-4B'
          infiltration_per_zone_entrydoor = 0.1297854
          infiltration_entrydoor.setSchedule(model_add_schedule(model, 'OfficeSmall INFIL_Door_Opening_SCH'))
        else
  ...
  # to do.. update google sheet to have the attic space, and remove autoassigned infiltration for attic, then add infiltration to attic.
 def add_attic_infiltration(climate_zone, model)
  # No attic infiltration for reference models
 unless template == 'DOE Ref 1980-2004' || template == 'DOE Ref Pre-1980'
