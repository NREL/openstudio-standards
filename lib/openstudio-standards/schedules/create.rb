...
module OpenstudioStandards
  module Schedules
    module Create
      ...
      def model_create_simple_schedule(model, options = {})
        defaults = {
          'name' => nil,
      ...
      def model_create_complex_schedule(model, options = {})
        defaults = {
          'name' => nil,
      ...
      def model_create_schedule_from_rate_of_change(model, schedule_ruleset)
      ...
      def model_create_weighted_merge_schedules(model, schedule_weights_hash, sch_name: 'Merged Schedule')
