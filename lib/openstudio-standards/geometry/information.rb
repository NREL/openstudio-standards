...
module OpenstudioStandards
  module Geometry
    ...
    def self.calculate_aspect_ratio(area, perimeter)
    ...
    #
    # @param surfaces [Array<OpenStudio::Model::Surface>] array of Surface objects
    # @param point [OpenStudio::Point3d]
    ...
    # Returns the wall area and window to wall ratio by orientation
    #
    # @param model [OpenStudio::Model::Model] OpenStudio model object
    # @param spaces [Array<OpenStudio::Model::Space>] optional array of Space objects.
    #   If provided, the return will report for only those spaces.
    # @return [Hash] Hash of wall area and window to wall ratio for each orientation
