...
class StandardsModel
  ...
  def model_add_ground_temperatures(model, building_type, climate_zone, template)
    ground_temp_vals = model_find_object($os_standards['ground_temperatures'], 'template' => template, 'climate_zone' => climate_zone, 'building_type' => building_type)
