class Standard
  ...
  def model_add_ground_temperatures(model, building_type, climate_zone)
    ground_temp_vals = model_find_object(table_name: 'ground_temperatures', search_criteria: {'template' => template, 'climate_zone' => climate_zone, 'building_type' => building_type})
