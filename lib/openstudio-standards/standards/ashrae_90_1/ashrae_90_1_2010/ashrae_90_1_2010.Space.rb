class ASHRAE9012010 < ASHRAE901
  ...
  def space_daylighting_fractions_and_windows(space,
    ...
    if req_top_ctrl && req_pri_ctrl
      ...
      elsif @instvarbuilding_type == 'MediumOffice' or @instvarbuilding_type == 'LargeOffice'
        # Some prototypes use bands of windows but use multiple
        # sensors to capture savings from code requirements
