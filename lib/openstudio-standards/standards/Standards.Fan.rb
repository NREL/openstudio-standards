...
module Fan
  ...
  def fan_standard_minimum_motor_efficiency_and_size(fan, motor_bhp)
    ...
    if fan_small_fan?(fan)
      ...
      motor_properties = standards_lookup_table_first(motors, search_criteria, motor_bhp)
    ...
    motor_properties = standards_lookup_table_first(motors, search_criteria, nominal_hp + 0.01)
    if motor_properties.nil?
