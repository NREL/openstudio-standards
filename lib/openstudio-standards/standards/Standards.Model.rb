...
class Standard
  ...
  def model_apply_hvac_efficiency_standard(model:, climate_zone:, apply_controls: true, sql_db_vars_map: nil, necb_reference_hp: false)
    ...
    model.getCoilHeatingDXSingleSpeeds.sort.each { |obj| sql_db_vars_map = coil_heating_dx_single_speed_apply_efficiency_and_curves(obj, sql_db_vars_map, necb_reference_hp) }
    ...
    model.getCoilCoolingDXSingleSpeeds.sort.each { |obj| sql_db_vars_map = coil_cooling_dx_single_speed_apply_efficiency_and_curves(obj, sql_db_vars_map, necb_reference_hp) }
