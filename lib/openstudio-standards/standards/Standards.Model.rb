...
class Standard
  ...
  # institution: ASHRAE, value: 6A  becomes: ASHRAE 169-6A.
  ...
  # For example: ASHRAE 169-2A, CEC T24-CEC3
  ...
  def model_set_climate_zone(model, climate_zone)
    ...
    if climate_zone.include? 'ASHRAE 169-'
      model.getClimateZones.setClimateZone('ASHRAE', climate_zone.gsub('ASHRAE 169-', ''))
