...
class Standard
  ...
  def load_standards_database
    ...
    standards_files << 'OpenStudio_Standards_fans_cv.json'
    standards_files << 'OpenStudio_Standards_fans_on_off.json'
    standards_files << 'OpenStudio_Standards_fans_vv.json'
    standards_files << 'OpenStudio_Standards_fans_zone_exhaust.json'
