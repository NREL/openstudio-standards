class DEER
  ...
  # this correlates to a baseline infiltration rate of 0.189 cfm/ft2 of exterior *surface* area at 75Pa.
  # *Note that this implies a baseline infiltration rate nearly 10 times lower than the PNNL modeling guideline.
  #
  ...
  def space_infiltration_rate_75_pa(space)
    basic_infil_rate_cfm_per_ft2 = 0.189
