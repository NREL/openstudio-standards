...
class NECB2011 < Standard
  ...
  def model_create_prototype_model(template:,
    ...
    return model_apply_standard(model: model,
                                ...
                                chiller_capacity_cop: chiller_capacity_cop # Options: (1) 'NECB_Default'/nil/'none'/false (i.e. do nothing), (2) e.g. 'ElectricEIRChiller York YT 2233kW/9.54COP/VSD'
    )
  ...
  def apply_systems_and_efficiencies(model:,
    ...
    ecm.modify_chiller_efficiency(model: model, chiller_capacity_cop: chiller_capacity_cop)
