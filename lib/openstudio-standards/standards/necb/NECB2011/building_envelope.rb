class NECB2011
  ...
  def set_construction_set_to_necb!(model, default_surface_construction_set,
    ...
    wall_rsi = 1.0 / (scale_wall * eval(self.model_find_objects(table_name: 'surface_thermal_transmittance',
                                                                search_criteria: {'boundary_condition' => 'Outdoors', 'surface' => 'Wall'})[0]['formula']))
    floor_rsi = 1.0 / (scale_floor * eval(self.model_find_objects(table_name: 'surface_thermal_transmittance',
                                                                  search_criteria: {'boundary_condition' => 'Outdoors', 'surface' => 'Floor'})[0]['formula']))
    roof_rsi = 1.0 / (scale_roof * eval(self.model_find_objects(table_name: 'surface_thermal_transmittance',
                                                                search_criteria: {'boundary_condition' => 'Outdoors', 'surface' => 'RoofCeiling'})[0]['formula']))
    ground_wall_rsi = 1.0 / (scale_ground_wall * eval(self.model_find_objects(table_name: 'surface_thermal_transmittance',
                                                                              search_criteria: {'boundary_condition' => 'Ground', 'surface' => 'Wall'})[0]['formula']))
    ground_floor_rsi = 1.0 / (scale_ground_floor * eval(self.model_find_objects(table_name: 'surface_thermal_transmittance',
                                                                                search_criteria: {'boundary_condition' => 'Ground', 'surface' => 'Floor'})[0]['formula']))
    ground_roof_rsi = 1.0 / (scale_ground_roof * eval(self.model_find_objects(table_name: 'surface_thermal_transmittance',
                                                                              search_criteria: {'boundary_condition' => 'Ground', 'surface' => 'RoofCeiling'})[0]['formula']))
    door_rsi = 1.0 / (scale_door * eval(self.model_find_objects(table_name: 'surface_thermal_transmittance',
                                                                search_criteria: {'boundary_condition' => 'Outdoors', 'surface' => 'Door'})[0]['formula']))
    window_rsi = 1.0 / (scale_window * eval(self.model_find_objects(table_name: 'surface_thermal_transmittance',
