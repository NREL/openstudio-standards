...
class NECB2015 < NECB2011
  ...
  def model_create_prototype_model(climate_zone:, epw_file:, sizing_run_dir: Dir.pwd, debug: false, measure_model: nil, x_scale: 1.0, y_scale: 1.0, z_scale: 1.0, osm_model_path:)
    model = build_prototype_model(climate_zone: climate_zone, debug: debug, epw_file: epw_file, sizing_run_dir: sizing_run_dir, x_scale: x_scale, y_scale: y_scale, z_scale: z_scale, osm_model_path: osm_model_path )
