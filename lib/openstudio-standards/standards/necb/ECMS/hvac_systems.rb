class ECMS
  ...
  def add_airloop_economizer(model:, airloop_economizer:)
    return if airloop_economizer.nil? || (airloop_economizer.to_s == 'NECB_Default')

    if airloop_economizer.downcase == "differentialenthalpy"
      economizer_type = 'DifferentialEnthalpy'
    elsif airloop_economizer.downcase == "differentialdrybulb"
