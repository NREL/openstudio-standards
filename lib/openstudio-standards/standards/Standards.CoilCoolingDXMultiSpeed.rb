class Standard
  ...
  def coil_cooling_dx_multi_speed_apply_efficiency_and_curves(coil_cooling_dx_multi_speed, sql_db_vars_map)
    ...
    if coil_dx_subcategory(coil_cooling_dx_multi_speed) == 'PTAC'
      ...
      new_comp_name = "#{coil_cooling_dx_multi_speed.name} #{capacity_kbtu_per_hr.round}kBtu/hr #{ptac_eer.to_f.round(1)}EER"
    ...
    unless ac_props['minimum_seasonal_energy_efficiency_ratio'].nil?
      ...
      new_comp_name = "#{coil_cooling_dx_multi_speed.name} #{capacity_kbtu_per_hr.round}kBtu/hr #{min_seer.to_f.round(1)}SEER"
    ...
    unless ac_props['minimum_energy_efficiency_ratio'].nil?
      ...
      new_comp_name = "#{coil_cooling_dx_multi_speed.name} #{capacity_kbtu_per_hr.round}kBtu/hr #{min_eer.to_f.round(1)}EER"
    ...
    unless ac_props['minimum_integrated_energy_efficiency_ratio'].nil?
      ...
      new_comp_name = "#{coil_cooling_dx_multi_speed.name} #{capacity_kbtu_per_hr.round}kBtu/hr #{min_ieer.to_f.round(1)}IEER"
